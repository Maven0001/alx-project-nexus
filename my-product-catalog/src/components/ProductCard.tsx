    ...
    >
      <div className="relative h-64 bg-linear-to-br from-gray-50 to-gray-100 overflow-hidden">
        ...
        {product.rating.rate >= 4.5 && (
          <div className="absolute top-4 left-4 bg-linear-to-r from-accent-500 to-accent-600 text-white px-3 py-1 rounded-full text-xs font-body font-bold shadow-lg">
            Best Seller
          </div>
        )}
      </div>
      ...
      <div className="p-6">
        ...
        <h3 className="font-display text-lg font-semibold text-gray-800 mb-2 line-clamp-2 min-h-14">
          {product.title}
        </h3>
        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-100">
          ...
          <button className="bg-linear-to-r from-primary-600 to-primary-500 text-white px-5 py-2.5 rounded-xl hover:shadow-lg transform hover:scale-105 transition-all font-body text-sm font-medium">
            Add to Cart
          </button>
        </div>
      </div>

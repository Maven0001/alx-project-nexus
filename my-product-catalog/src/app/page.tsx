...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="">
        {/* Hero Section */}
        <section className="bg-linear-to-r from-primary-600 via-primary-500 to-accent-600 text-slate-900 py-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-4 ">
            ...
            >
              ...
              <p className="font-body text-lg md:text-xl max-w-3xl mx-auto mb-4">
